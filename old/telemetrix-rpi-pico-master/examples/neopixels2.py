...
def neopixel_demo2(my_board):
    ...
    my_board.set_pin_mode_neopixel(pin_number=22,num_pixels=17)
    t = 0.03*18
    ...
    for i in range(30):
        my_board.neo_pixel_set_value(randint(0, 16), randint(0, 16), randint(0, 64),
                                     randint(0, 64), True)
        time.sleep(.2)
